    ...
    return (
        <div className="container mx-auto p-4">
            <header className="flex justify-between items-center mb-8">
                ...
                <Link href="/cart" className="bg-blue-500 text-white px-5 py-2 rounded hover:bg-blue-600">
                    View Cart
                </Link>
            </header>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 hover:shadow-lg">
                {products.map((product) => (
                    <div key={product.id} className="border p-4 rounded">
                        ...
                        <button
                            ...
                            className="mt-2 bg-white-500 text-black px-4 py-2 rounded hover:bg-white-600 transition duration-300"
                        >
                            <Link href="/cart" className="bg-blue-500 text-white px-4 py-2 rounded text align-center hover:bg-blue-600">
                                Add to Cart
                            </Link>            
